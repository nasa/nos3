...
do
    ...
    gnome-terminal --tab --title=$SC_NUM" - Newsim Sim"   -- $DFLAGS -v $SIM_DIR:$SIM_DIR --name $SC_NUM"_newsim_sim"   --network=$SC_NETNAME -w $SIM_BIN $DBOX ./nos3-single-simulator $SC_CFG_FILE newsim_sim
