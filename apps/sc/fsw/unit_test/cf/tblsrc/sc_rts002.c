 /*************************************************************************
 ** File:
 **   $Id: sc_rts002.c 1.3 2015/03/02 12:58:35EST sstrege Exp  $
 **
 ...
 **
 **   $Log: sc_rts002.c  $ 
 **   Revision 1.3 2015/03/02 12:58:35EST sstrege  
 **   Added copyright information 
 **   Revision 1.2 2009/02/19 10:06:58EST nyanchik  
 **   Update SC To work with cFE 5.2 Config parameters 
 **   Revision 1.1 2009/01/26 14:42:08EST nyanchik  
 **   Initial revision 
...
uint16     SC_Rts002[SC_RTS_BUFF_SIZE] = {
/* This is a table that  runs off  the end of the buffer*/
...
0x0000, 0x0000, 0x18A9, 0xC000, 0x0001, 0x008F,
0x0000, 0x0000, 0x18A9, 0xC000, 0x0001, 0x008F,
0x0000, 0x0000, 0x18A9, 0xC000, 0x0005, 0x0700, 0x0001, 0x0000
};

CFE_TBL_FILEDEF(SC_Rts002, SC_APP.RTS_TBL002, SC RTS table 002,RTS_TBL002.tbl)
