 /*************************************************************************
 ** File:
 **   $Id: sc_ats1b.c 1.2 2015/03/02 12:58:59EST sstrege Exp  $
 **
 ...
 **
 **   $Log: sc_ats1b.c  $ 
 **   Revision 1.2 2015/03/02 12:58:59EST sstrege  
 **   Added copyright information 
 **   Revision 1.1 2009/01/26 14:41:58EST nyanchik  
 **   Initial revision 
...
uint16     SC_Ats1b[SC_ATS_BUFF_SIZE] = {
/* This table tests two command having the same command number
   This table won't pass validation */

0x0000, 0x0001, 0x0000, 0x0002, 0x18A9, 0xC000, 0x0001, 0x008F,
0x0000, 0x0001, 0x0000, 0x0004, 0x18A9, 0xC000, 0x0001, 0x008F,
0x0000, 0x0003, 0x0000, 0x0006, 0x18A9, 0xC000, 0x0001, 0x008F


};

CFE_TBL_FILEDEF(SC_Ats1b, SC_APP.ATS_TBL1, SC ATS table 1b,ATS_TBL1b.tbl)
