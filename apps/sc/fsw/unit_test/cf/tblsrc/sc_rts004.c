 /*************************************************************************
 ** File:
 **   $Id: sc_rts004.c 1.2 2015/03/02 12:58:32EST sstrege Exp  $
 **
 ...
 **
 **   $Log: sc_rts004.c  $ 
 **   Revision 1.2 2015/03/02 12:58:32EST sstrege  
 **   Added copyright information 
 **   Revision 1.1 2009/01/26 14:42:11EST nyanchik  
 **   Initial revision 
...
uint16     SC_Rts004[SC_RTS_BUFF_SIZE] = {

/* This is a table where the first command has an invalid Message ID */
0x0000, 0x0001, 0x0000, 0xC000, 0x0001, 0x008F

};

CFE_TBL_FILEDEF(SC_Rts004, SC_APP.RTS_TBL004, SC RTS table 004,RTS_TBL004.tbl)
