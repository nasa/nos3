 /*************************************************************************
 ** File:
 **   $Id: sc_rts003.c 1.2 2015/03/02 12:58:34EST sstrege Exp  $
 **
 ...
 **
 **   $Log: sc_rts003.c  $ 
 **   Revision 1.2 2015/03/02 12:58:34EST sstrege  
 **   Added copyright information 
 **   Revision 1.1 2009/01/26 14:42:09EST nyanchik  
 **   Initial revision 
...
uint16     SC_Rts003[SC_RTS_BUFF_SIZE] = {

/* This is a table where the first command has too big of a size */
0x0000, 0x0001, 0x18A9, 0xC000, 0xFFF1, 0x008F

};

CFE_TBL_FILEDEF(SC_Rts003, SC_APP.RTS_TBL003, SC RTS table 003,RTS_TBL003.tbl)
