 /*************************************************************************
 ** File:
 **   $Id: sc_rts005.c 1.2 2015/03/02 12:58:27EST sstrege Exp  $
 **
 ...
 **
 **   $Log: sc_rts005.c  $ 
 **   Revision 1.2 2015/03/02 12:58:27EST sstrege  
 **   Added copyright information 
 **   Revision 1.1 2009/01/26 14:42:12EST nyanchik  
 **   Initial revision 
...
uint16     SC_Rts005[SC_RTS_BUFF_SIZE] = {
/* This is a valid table and its second command has a checksum error*/
/* 8F below is the checksum for the command */
0x0000, 0x0001, 0x18A9, 0xC000, 0x0001, 0x008F,
0x0000, 0x0000, 0x18A9, 0xC000, 0x0001, 0x00FF
};

CFE_TBL_FILEDEF(SC_Rts005, SC_APP.RTS_TBL005, SC RTS table 005,RTS_TBL005.tbl)
