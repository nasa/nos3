 /*************************************************************************
 ** File:
 **   $Id: sc_rts008.c 1.2 2015/03/02 12:59:00EST sstrege Exp  $
 **
 ...
 **
 **   $Log: sc_rts008.c  $ 
 **   Revision 1.2 2015/03/02 12:59:00EST sstrege  
 **   Added copyright information 
 **   Revision 1.1 2009/01/26 14:42:15EST nyanchik  
 **   Initial revision 
...
uint16     SC_Rts008[SC_RTS_BUFF_SIZE] = {
/* This is a table where the last valid command is within the
   table, but another comman starts after in where the smallest
   command couldn't even fit*/
...
0x0002, 0x0000, 0x18A9, 0xC000
};

CFE_TBL_FILEDEF(SC_Rts008, SC_APP.RTS_TBL008, SC RTS table 008,RTS_TBL008.tbl)
