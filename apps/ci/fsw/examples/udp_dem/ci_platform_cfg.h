...
*
*   \brief Sample config file for CI Application with UDP-DEM socket
*
...
#define CI_CUSTOM_UDP_PORT_CCSDS 5010
#define CI_CUSTOM_UDP_PORT_DEM   5012

#define CI_CUSTOM_UDP_ADDR IO_TRANS_UDP_INADDR_ANY
#define CI_CUSTOM_UDP_TIMEOUT 100
#define CI_CUSTOM_MAX_IP_STRING_SIZE  16 

#define CI_CUSTOM_DEM_BUFFER_SIZE 1000
#define CI_CUSTOM_CFS_BUFFER_SIZE 1000
#define CI_CUSTOM_DEM_CCSDS_CONFIG_SIZE 21
