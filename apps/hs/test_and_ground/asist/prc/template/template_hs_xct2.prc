...
;	that contains two entries in slots 6 and 7 whose application will never
;	execute.
;
;  Requirements Tested
;       None
...
;; Entry 6
$SC_$CPU_HS_XCT[6].ResourceName = "SC"
$SC_$CPU_HS_XCT[6].NullTerm = 0
$SC_$CPU_HS_XCT[6].ResourceType = HS_XCT_TYPE_APP_MAIN

;; Entry 7
$SC_$CPU_HS_XCT[7].ResourceName = "TST_SC"
$SC_$CPU_HS_XCT[7].NullTerm = 0
$SC_$CPU_HS_XCT[7].ResourceType = HS_XCT_TYPE_APP_MAIN

for index = 8 to HS_MAX_EXEC_CNT_SLOTS do
...
s create_tbl_file_from_cvt ("$CPU",apid,"Execution Counter Table Load 2","hs_def_xct2",xctTblName,"$SC_$CPU_HS_XCT[1].ResourceName",endmnemonic)

write ";*********************************************************************"
write ";  End procedure $SC_$CPU_hs_xct2 "
write ";*********************************************************************"
ENDPROC
