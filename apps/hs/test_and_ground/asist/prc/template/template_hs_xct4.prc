...
$SC_$CPU_HS_XCT[5].ResourceType = HS_XCT_TYPE_ISR + 1
...
s create_tbl_file_from_cvt ("$CPU",apid,"Execution Counter Table Invalid Load","hs_def_xct4",xctTblName,"$SC_$CPU_HS_XCT[1].ResourceName",endmnemonic)

write ";*********************************************************************"
write ";  End procedure $SC_$CPU_hs_xct4 "
write ";*********************************************************************"
ENDPROC
