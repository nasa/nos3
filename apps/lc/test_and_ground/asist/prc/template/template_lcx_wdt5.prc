...
;	(WDT) 5 in order to test the new StaleAge option developed for the LCX
;	Application.
;
;  Requirements Tested
;       None
...
s create_tbl_file_from_cvt("$CPU",apid,"WDTTable5","lc_def_wdt5.tbl",tableName,startMnemonic,endMnemonic)

write ";*********************************************************************"
write ";  End procedure $SC_$CPU_lcx_wdt5                                     "
write ";*********************************************************************"
ENDPROC
