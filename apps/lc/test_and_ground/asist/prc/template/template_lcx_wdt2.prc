...
;	Table (WDT) used for testing.
;       Note that the message ids used are borrowed from the other CFS
;	applications (MM, FM, MD, and SCH).    
;
;  WDT2:  Used by TableTesting and Initialization procedures.  
;         19 unique MsgIds, 28 WPs, Entries include 
...
$SC_$CPU_LC_WDT[entry].Bitmask = 0xFFFFFFFF
$SC_$CPU_LC_WDT[entry].ComparisonValue.Float32 = 65.98765432
$SC_$CPU_LC_WDT[entry].CustFctArgument = 0
$SC_$CPU_LC_WDT[entry].StaleAge = 0
...
for entry=28 to LC_MAX_WATCHPOINTS-1 do
...
s create_tbl_file_from_cvt("$CPU",apid,"WDTTable2","lc_def_wdt2.tbl",tableName,startMnemonic,endMnemonic)

write ";*********************************************************************"
write ";  End procedure $SC_$CPU_lcx_wdt2                                     "
write ";*********************************************************************"
ENDPROC
