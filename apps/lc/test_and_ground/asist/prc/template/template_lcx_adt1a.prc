...
;	(MM, FM, MD, and SCH). 
;
;  ADT1:  Used by NoAction procedure.  
;         Contains 10 APs, uses all event types and RPN operators;  
;
;  Requirements Tested
;       None
;
...
;	9/27/12		W.Moleski	Initial release for LCX
;
;  Arguments
;	None.
;
...
$SC_$CPU_LC_ADT[entry].RPNEquation[1] = 13
$SC_$CPU_LC_ADT[entry].RPNEquation[2] = 28
...
$SC_$CPU_LC_ADT[entry].RPNEquation[2] = 14
...
$SC_$CPU_LC_ADT[entry].RPNEquation[1] = 21
$SC_$CPU_LC_ADT[entry].RPNEquation[2] = LC_RPN_NOT
$SC_$CPU_LC_ADT[entry].RPNEquation[3] = 29
$SC_$CPU_LC_ADT[entry].RPNEquation[4] = LC_RPN_AND
$SC_$CPU_LC_ADT[entry].RPNEquation[5] = 28
...
$SC_$CPU_LC_ADT[entry].RPNEquation[1] = 16
$SC_$CPU_LC_ADT[entry].RPNEquation[2] = LC_RPN_EQUAL
...
$SC_$CPU_LC_ADT[entry].MaxFailsBefRTS =  5
$SC_$CPU_LC_ADT[entry].RPNEquation[1] = 16
$SC_$CPU_LC_ADT[entry].RPNEquation[2] = 17
$SC_$CPU_LC_ADT[entry].RPNEquation[3] = LC_RPN_OR
$SC_$CPU_LC_ADT[entry].RPNEquation[4] = 19
$SC_$CPU_LC_ADT[entry].RPNEquation[5] = LC_RPN_AND
$SC_$CPU_LC_ADT[entry].RPNEquation[6] = 13
...
$SC_$CPU_LC_ADT[entry].MaxFailPassEvents = 2
$SC_$CPU_LC_ADT[entry].MaxFailsBefRTS = 2
$SC_$CPU_LC_ADT[entry].RPNEquation[1] = 22
$SC_$CPU_LC_ADT[entry].RPNEquation[2] = 23
$SC_$CPU_LC_ADT[entry].RPNEquation[3] = 24
...
s create_tbl_file_from_cvt("$CPU",appid,"ADTTable1a","lc_def_adt1a.tbl",ADTTblName,startMnemonic,endMnemonic)

write ";*********************************************************************"
write ";  End procedure $SC_$CPU_lcx_adt1a"
write ";*********************************************************************"
ENDPROC
