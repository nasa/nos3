...
;	Table (ADT) 6 to be used for the LCx application to determine if the
...
s create_tbl_file_from_cvt("$CPU",appid,"ADT Stale Table","lc_def_adt6.tbl",ADTTblName,startMnemonic,endMnemonic)

write ";*********************************************************************"
write ";  End procedure $SC_$CPU_lcx_adt6                                     "
write ";*********************************************************************"
ENDPROC
