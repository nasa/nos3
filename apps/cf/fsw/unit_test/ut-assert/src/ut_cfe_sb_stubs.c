...
**
** $Id: ut_cfe_sb_stubs.c 1.1.1.1 2015/03/06 15:30:39EST sstrege Exp  $
**
...
** Revision 1.1.1.1 2015/03/06 15:30:39EST sstrege 
...
void Ut_CFE_SB_SetFunctionHook(uint32 Index, void *FunPtr)
{
    ...
    else                                                  { printf("Unsupported SB Index In SetFunctionHook Call %lu\n", Index); }
}
