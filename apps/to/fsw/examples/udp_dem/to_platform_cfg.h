...
#define TO_DEFAULT_DEST_PORT_CCSDS      5011
#define TO_DEFAULT_DEST_PORT_DEM        5013 
#define TO_DEFAULT_DEST_PORT_DEM_KSC    5014

#define TO_CUSTOM_DEM_BUFFER_SIZE 1000
#define TO_CUSTOM_CCSDS_DEM_CONFIG_SIZE 28
