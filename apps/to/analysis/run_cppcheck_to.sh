...
paths_to_check="$to_app/src/ $to_app/examples/multi/ $to_app/examples/multi_tf/ $to_app/examples/rs422/ $to_app/examples/udp/ $to_app/examples/udp_dem/"

include_dirs="-I $to_app/platform_inc/ -I $to_app/mission_inc -I $io_lib/public_inc  -I $c3i_lib/public_inc"
