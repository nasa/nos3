...
********************************************************************/
CFS_MODULE_DECLARE_APP(sch, 40, 8192);
...
int32 SCH_EvsInit(void)
{
    ...
    SCH_AppData.EventFilters[0].RateLimit = 0xffff;
    SCH_AppData.EventFilters[0].BurstLimit = 1;

    SCH_AppData.EventFilters[1].EventID = SCH_MULTI_SLOTS_EID;
    SCH_AppData.EventFilters[1].RateLimit = 0xffff;
    SCH_AppData.EventFilters[1].BurstLimit = 1;

    SCH_AppData.EventFilters[2].EventID = SCH_SKIPPED_SLOTS_EID;
    SCH_AppData.EventFilters[2].RateLimit = 0xffff;
    SCH_AppData.EventFilters[2].BurstLimit = 1;

    SCH_AppData.EventFilters[3].EventID = SCH_CORRUPTION_EID;
    SCH_AppData.EventFilters[3].RateLimit = 0xffff;
    SCH_AppData.EventFilters[3].BurstLimit = 2;

    SCH_AppData.EventFilters[4].EventID = SCH_PACKET_SEND_EID;
    SCH_AppData.EventFilters[4].RateLimit = 0xffff;
    SCH_AppData.EventFilters[4].BurstLimit = 1;
...
int32 SCH_TblInit(void)
{
    ...
    */
    Status = CFE_TBL_Load(SCH_AppData.ScheduleTableHandle,
                          CFE_TBL_SRC_ADDRESS,
                          (const void *) SCH_DefaultScheduleTable);
    ...
    */
    Status = CFE_TBL_Load(SCH_AppData.MessageTableHandle,
                          CFE_TBL_SRC_ADDRESS,
                          (const void *) SCH_DefaultMessageTable);
