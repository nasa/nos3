...
s create_tbl_file_from_cvt (hostCPU,defTblId,"Table Definition Table Invalid State","tbl_def_tbl_invalid",tblDefTblName,"$SC_$CPU_CS_TBL_DEF_TABLE[0].State",endmnemonic)
