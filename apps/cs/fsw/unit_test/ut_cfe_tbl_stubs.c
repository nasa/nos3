...
**
** $Id: ut_cfe_tbl_stubs.c 1.1 2017/01/18 12:26:51EST czogby Exp  $
**
...
** Revision 1.1 2017/01/18 12:26:51EST czogby 
** Initial revision
** Member added to project /CFS-APPs-PROJECT/cs/fsw/unit_test/project.pj
...
void Ut_CFE_TBL_SetFunctionHook(uint32 Index, void *FunPtr)
{
    ...
    else if (Index == UT_CFE_TBL_SHARE_INDEX)           { Ut_CFE_TBL_HookTable.CFE_TBL_Share = FunPtr; }
