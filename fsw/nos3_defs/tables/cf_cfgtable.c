...
/*
** Sample playback table data - See NOTE Above
*/

cf_config_table_t     CF_ConfigTable =
{

    "Sample CF Table",/* TableIdString */
    2,      /* TableVersion (integer)   */    
    4,      /* NumEngCyclesPerWakeup    */
    2,      /* NumWakeupsPerQueueChk    */
    16,     /* NumWakeupsPerPollDirChk  */
    100,    /* UplinkHistoryQDepth      */
    0,      /* Reserved1                */
    0,      /* Reserved2                */
    "10",   /* AckTimeout (secs, entered as string) */
    "25",   /* AckLimit (max timeouts, string)      */
    "5",    /* NakTimeout (secs, string)            */
    "25",   /* NakLimit (max timeouts, string)      */
    "30",   /* InactivityTimeout (secs, string)     */
