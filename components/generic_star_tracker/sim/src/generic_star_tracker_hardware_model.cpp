...
namespace Nos3
{
    ...
    void Generic_star_trackerHardwareModel::create_generic_star_tracker_data(std::vector<uint8_t>& out_data)
    {
        ...
        */
        double dx = data_point->get_generic_star_tracker_data_x();
        double dy = data_point->get_generic_star_tracker_data_y();
        double dz = data_point->get_generic_star_tracker_data_z();
        ...
        sim_logger->debug("Generic_star_trackerHardwareModel::create_generic_star_tracker_data: data_point=%f, %f, %f, converted values=%u, %u, %u.", dx, dy, dz, x, y, z);
